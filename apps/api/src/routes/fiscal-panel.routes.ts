...
router.get(
  "/torneos/:id/partidos",
  requireFiscalAsignadoAlTorneo,
  FiscalPanelController.getPartidos,
);
router.get(
  "/torneos/:id/jugadores",
  requireFiscalAsignadoAlTorneo,
  FiscalPanelController.getJugadores,
);
router.get(
  "/torneos/:id/incidencias",
  requireFiscalAsignadoAlTorneo,
  FiscalPanelController.getIncidencias,
);
router.post(
  "/torneos/:id/incidencias",
  requireFiscalAsignadoAlTorneo,
  FiscalPanelController.postIncidencia,
);
router.patch(
  "/torneos/:id/incidencias/:incidenciaId",
  requireFiscalAsignadoAlTorneo,
  requireFiscalGeneral,
  FiscalPanelController.patchIncidencia,
);
router.get(
  "/torneos/:id/reporte",
  requireFiscalAsignadoAlTorneo,
  FiscalPanelController.getReporte,
);
