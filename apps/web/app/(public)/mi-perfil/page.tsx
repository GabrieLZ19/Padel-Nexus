...
export default function PlayerDashboard() {
  ...
  return (
    <main className="max-w-6xl mx-auto p-5 md:p-10 space-y-8 md:space-y-10 relative isolate">
      ...
      {/* BENTO GRID MAESTRO */}
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 md:auto-rows-[1fr] relative z-10">
        {!profile ? (
          <>
            <Skeleton className="order-4 md:order-1 col-span-2 md:col-span-1 md:row-span-2 min-h-80" />
            <Skeleton className="order-1 md:order-2 col-span-2 md:col-span-3 min-h-35" />
            <Skeleton className="order-2 md:order-3 col-span-1 min-h-40" />
            <Skeleton className="order-3 md:order-4 col-span-1 min-h-40" />
            <Skeleton className="order-4 md:order-5 col-span-2 md:col-span-1 min-h-40" />
          </>
        ) : (
          <>
          ...
          <div className="order-1 md:order-2 col-span-2 md:col-span-3 bg-brand-card p-6 md:p-8 rounded-3xl border border-brand-white/5 flex items-center justify-between group hover:border-brand-white/10 transition-colors overflow-hidden relative">
          ...
          <Link
            ...
            className="order-4 md:order-5 col-span-2 md:col-span-1 bg-brand-card p-5 md:p-8 rounded-3xl border border-brand-white/5 hover:border-brand-chartreuse/40 transition-all flex flex-col items-center justify-center text-center gap-4 group cursor-pointer"
          >
            <div className="p-4 bg-brand-white/5 rounded-2xl group-hover:bg-brand-chartreuse/10 transition-colors">
